...
[
  ...
  ['Library.JQuery.DirectoryHandler', require('./library/jQuery/handler/directoryHandler')],
  ['Library.JQuery.JQueryHandler', require('./library/jQuery/handler/jQueryHandler')],
  ['Library.JQueryUI', require('./library/jQueryUI')],
  ['Library.JQueryUI.JQueryUIHandler', require('./library/jQueryUI/handler/jQueryUIHandler')],
  ...
  ['Plugin.Router.VirtualHandler', require('./plugin/router/handler/virtualHandler')],
  ...
  ['Plugin.Layout.DirectoryHandler', require('./plugin/layout/handler/directoryHandler')],
  ...
  ['Plugin.ThemeBootstrap.DirectoryHandler', require('./plugin/themeBootstrap/handler/directoryHandler')],
  ['Plugin.ThemeBootstrap.BootstrapDirectoryHandler', require('./plugin/themeBootstrap/handler/bootstrapDirectoryHandler')],
