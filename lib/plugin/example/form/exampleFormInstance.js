...
class ExampleForm extends Form {
  constructor(buildState, ivBase) {
    ...
    this.instanceSetup.data.attributes.id.add('yo');
    this.instanceSetup.data.attributes.class.add('foo');
    this.instanceSetup.data.attributes.class.add('bar');
    this.instanceSetup.data.attributes.class.add('baz');
  }
