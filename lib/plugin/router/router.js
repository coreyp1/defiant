...
class Router extends Plugin {
   ...
   * @returns {Defiant.Plugin.Router} The app router.
   */
  constructor(engine) {
    super(engine);
  ...
  /**
   * @function
   * @param {Defiant.Plugin.Router.Handler} handler Add a handler to the router.
  ...
  /**
   * Accept an incoming request context and
   * @function
   * @async
