...
class PermissionHandler extends Handler {
   ...
   * @returns {Defiant.Plugin.Router.Handler.PermissionHandler}
   ...
   * @returns {boolean} Return `true` if the account has access.
   */
...
/**
 * @prop {String[]} Defiant.Plugin.Router.Handler.PermissionHandler.permissions
