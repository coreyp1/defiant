...
// When calling Attribute.form{Init, Validate, Submit}, should the attributes be
// processed individually, or as a group?
Attribute.formType = 'individual';  // 'individual' or 'group';
