...
/**
 * Provide an Entity edit form.  This handler is specific to an individual
 * Entity type.
 * @class
...
class EntityEditHandler extends Handler {
   ...
   * @param {String} form
   *   The id of the form to associate with this entity edit handler.
   * @returns {Defiant.Plugin.Orm.EntityEditHandler}
   *   The instantiated EntityEditHandler.
   */
  constructor(data={}) {
    super(data);
    [
      /**
       * @member {String} Defiant.Plugin.Orm.EntityEditHandler#form
       *   The id of the form to associate with this entity edit handler.
       */
      'form',
