...
/**
 * Provide an Entity creation form.  This handler is specific to an individual
 * Entity type.
 * @class
 * @extends Defiant.Plugin.Router.Handler
 * @memberOf Defiant.Plugin.Orm
 */
class EntityCreateHandler extends Handler {
  /**
   ...
   * @param {String} form
   *   The id of the form to associate with this entity creation handler.
   * @returns {Defiant.Plugin.Orm.EntityCreateHandler}
   *   The instantiated EntityCreateHandler.
   */
  constructor(data={}) {
    super(data);
    [
      /**
       * @member {String} Defiant.Plugin.Orm.EntityCreateHandler#form
       *   The id of the form to associate with this entity creation handler.
       */
      'form',
...
module.exports = EntityCreateHandler;
