  ...
  async init(data={}) {
    ...
    this.addInstance(TagPair.newInstance(this.context, {
      ...
      data:{
        ...
        content: this.context.post[this.formInstance.id][this.name] != undefined ? this.context.post[this.formInstance.id][this.name] : this.data.defaultValue ? this.data.defaultValue : '',
      },
    }));
