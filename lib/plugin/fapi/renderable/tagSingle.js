...
TagSingle.boilerplate = "attributes = ((typeof attributes == 'object') ? Object.keys(attributes).map(name => attributes[name] == undefined ? name : `${name}=\"${attributes[name]}\"`).join(' ') : attributes) || '';";
