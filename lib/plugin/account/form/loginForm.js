...
class LoginForm extends Form {
  ...
  validate(context) {
    ...
    let AccountEntity = context.engine.pluginRegistry.get('Orm').entity.get('account')
  ...
  submit(context) {
    ...
    return co(function*(self){
      ...
      yield context.engine.pluginRegistry.get('Session').writeSessionFile(context.session);
