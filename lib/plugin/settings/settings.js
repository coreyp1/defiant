...
class Settings extends Plugin {
  constructor(engine) {
    ...
    // Monkey patch cache.set() so that it automatically registers with the type
    // registry and also creates a reference within the data object to this.
  ...
  init() {
    return co(function* (self) {
      ...
      self.engine.plugin.get('Router').router
        .addHandler(require('./handler/settingsPathsHandler'));
      ...
      // 'locations' and 'overrides' are special-case variables.  Pre-load them now.
