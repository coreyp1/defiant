...
class Settings extends Plugin {
  ...
  init() {
    return co(function* (self) {
      const FormApi = self.engine.pluginRegistry.get('FormApi');
      ...
      self.engine.pluginRegistry.get('Router')
      ...
      self.cacheRegistry.set(new Data({
      ...
      self.locations = self.cacheRegistry.get('settings/locations.json');
      yield self.locations.load();
      self.overrides = self.cacheRegistry.get('settings/classMapOverride.json');
